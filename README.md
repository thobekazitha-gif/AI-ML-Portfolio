...
Tools & Platforms:
Figma | Canva | GitHub | Oracle VirtualBox | Napkin AI | Builder.io

Other Skills:
Project management | Digital marketing | Problem-solving | Creative thinking
...
Live Demo: View Dashboard
 (replace # with live link if available)
